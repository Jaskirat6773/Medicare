...
class NotificationService {
  ...
  static void _handleNotificationClick(NotificationResponse response) {
    if (response.payload != null) {
      Navigator.of(navigatorKey.currentState!.context).push(
        MaterialPageRoute(
          builder: (context) => FirebaseAuth.instance.currentUser == null ? LoginScreen(): DetailsScreen(docId: response.payload!),
        ),
      );
    }
  }
  ...
  static void _handleFirebaseNotificationClick(RemoteMessage message) {
    if (message.data.isNotEmpty) {
      ...
      ).push(MaterialPageRoute(builder: (context) => FirebaseAuth.instance.currentUser == null ? LoginScreen(): DetailsScreen(docId: id)));
    }
  }
